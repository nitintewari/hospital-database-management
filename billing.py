...
def date_up():
    ...
    conn.commit()
    tkinter.messagebox.showinfo("VIT HOSPITAL MANAGEMENT SYSTEM", "DISCHARGE DATE UPDATED")
...
def up():
    ...
    conn.commit()
    tkinter.messagebox.showinfo("VIT HOSPITAL MANAGEMENT SYSTEM", "BILLING DATA SAVED")
